<?php 
	...
	$update_product_query = "update productos set product_nombre = '$nombre_product', descripcion = '$desc_product', cantidad = $amount_product, categoria_id_categoria = $cat_product where id_producto = $id_pro";
